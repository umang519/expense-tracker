...
export default function ExpenseList({ month, currency = "INR", initialExpenses, initialCategories }: Props) {
  ...
  if (isError) {
    return (
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-red-100 dark:border-red-900/50 p-6 text-center mt-2">
        <p className="text-sm text-red-500 dark:text-red-400">Could not load expenses. Try refreshing.</p>
      </div>
    );
  }
    ...
    <>
      ...
      <div className="flex items-center gap-2 mt-2 mb-1">
        <select
          ...
          className="flex-1 min-w-0 text-xs border border-gray-200 dark:border-gray-700 rounded-lg px-2 py-1.5 bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-400 focus:outline-none focus:ring-1 focus:ring-violet-400"
        >
        ...
        <input
          ...
          className="flex-1 min-w-0 text-xs border border-gray-200 dark:border-gray-700 rounded-lg px-2 py-1.5 bg-white dark:bg-gray-900 placeholder-gray-300 dark:placeholder-gray-600 text-gray-600 dark:text-gray-400 focus:outline-none focus:ring-1 focus:ring-violet-400"
        />
        ...
        <a
          ...
          download
          title="Download CSV"
          className="flex-shrink-0 flex items-center justify-center w-8 h-[30px] border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-400 dark:text-gray-500 hover:text-violet-600 dark:hover:text-violet-400 hover:border-violet-300 dark:hover:border-violet-700 transition-colors"
        >
      ...
      {filtered.length === 0 && hasFilters && (
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-8 text-center mt-2">
          <p className="text-gray-400 dark:text-gray-500 text-sm">No expenses match your filters.</p>
          <button
            onClick={() => { setFilterCategoryId(""); setFilterNote(""); }}
            className="mt-2 text-xs text-violet-500 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300"
          >
            Clear filters
          </button>
        </div>
