    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 z-10">
        ...
        <input
          ...
          placeholder="DELETE"
          disabled={loading}
          className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-900 mb-2 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent disabled:opacity-60"
        />

        {error && (
          <p className="text-xs text-red-600 bg-red-50 rounded-lg px-3 py-1.5 mb-2">{error}</p>
        )}
