  ...
  return (
    <div className="w-full max-w-sm">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-8">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Start tracking your expenses</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={`${inputClass} ${emailError ? "border-red-300 dark:border-red-700 focus:ring-red-400" : ""}`}
          ...
          <div>
            ...
            <PasswordInput
              ...
              className={`${inputClass} ${passwordError ? "border-red-300 dark:border-red-700 focus:ring-red-400" : ""}`}
